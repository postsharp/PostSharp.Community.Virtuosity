    ...
    public class NewPropertyIntegrationTests 
{
    ...
    public NewPropertyIntegrationTests()
    {
        ...
        var baseType = typeof(BaseProperty);
        derivedType = typeof(DateTimeOffsetProperty);
        genericDerivedType = typeof(GenericProperty<DateTimeOffset>);
    ...
    public void Get_Generic_WhenPropertyUsesSameBackingFieldAsBase_MustGetValueFromBase()
    {
        ...
        object instance = Activator.CreateInstance(genericDerivedType);
